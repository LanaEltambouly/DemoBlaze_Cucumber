...
public class MonitorsCatPage extends HomePage {
    ...
    public List<String> expectedLaptopsAndPhones = Arrays.asList("Sony vaio i5", "Sony vaio i7",
            "MacBook air", "Dell i7 8gb", "2017 Dell 15.6 Inch", "MacBook Pro","Samsung galaxy s6",
